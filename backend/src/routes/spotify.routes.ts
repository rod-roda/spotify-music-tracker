...
import { topTracksController, topArtistsController, profileController } from "../controllers/spotify.controller";
...
{
    app.get('/me/profile', { preHandler: requireSpotifyAuth }, profileController);
